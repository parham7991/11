...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'درباره آفلند | سرزمینِ تخفیف',
    description: 'تخصص در قطعات کامپیوتر، دستیار هوشمند خرید و جادوگر اسمبل هوشمند با بهترین قیمت.',
    url: `${SITE_URL}/about`,
    locale: 'fa_IR',
    siteName: 'آفلند',
    type: 'website',
  ...
  return (
    ...
    >
      ...
      <section className="overflow-hidden rounded-2xl border border-[var(--offl-border)] bg-gradient-to-bl from-[#386bf91a] via-[var(--offl-surface)] to-[var(--offl-surface)] p-7 lg:p-10">
        <p className="font-medium text-sm text-[var(--offl-primary)]">سرزمینِ تخفیف</p>
        ...
        <p className="mt-4 max-w-3xl font-reqular text-[15px] leading-8 text-[var(--offl-text-muted)]">
          آفلند یعنی تخصص، قیمت رقابتی و اطمینان. ما آمده‌ایم تا خرید قطعات کامپیوتر و لوازم دیجیتال
          را برای هر کسی — از گیمر و تدوین‌گر گرفته تا ادمین‌های شرکتی — ساده، شفاف و مقرون‌به‌صرفه
          کنیم. با{' '}
          <span className="font-medium text-[var(--offl-primary)]">دستیار هوشمند آفلند</span> مشورت
          کن، یا با{' '}
      ...
      <LegalSection title="داستان ما">
        <p>
          آفلند از یک سؤال ساده شروع شد: «چرا خرید قطعهٔ درست برای سیستم باید این‌قدر گیج‌کننده و
          پرریسک باشد؟» ما که خودمان عاشق سخت‌افزار بودیم، می‌دیدیم خیلی‌ها به‌خاطر نبود مشاورهٔ
          درست، یا قطعهٔ ناسازگار می‌خرند یا بودجه‌شان را هدر می‌دهند.
        </p>
        <p>
          پس «سرزمینِ تخفیف» را ساختیم — جایی که تخصص فنی، هوش مصنوعی و قیمت منصفانه در کنار هم قرار
          گرفتند تا هر خریدار، از مبتدی تا حرفه‌ای، بهترین تصمیم را بگیرد. آفلند نه یک فروشگاه
          معمولی، بلکه همراه فنیِ تو در هر خرید است.
        </p>
      </LegalSection>
      ...
      <LegalSection title="مأموریت، چشم‌انداز و ارزش‌های ما">
        <div className="grid gap-4 md:grid-cols-3">
          <LegalCard title="مأموریت ما">
            دموکراتیزه‌کردن خرید سخت‌افزار: مشاورهٔ رایگان، مقایسهٔ شفاف و قیمتی که واقعاً «تخفیف»
            باشد — نه فقط ادعا.
          </LegalCard>
          <LegalCard title="چشم‌انداز ما">
            تبدیل شدن به اولین مقصد هوشمند خرید کالای دیجیتال در ایران؛ جایی که هر تصمیم، با داده و
            هوش مصنوعی پشتیبانی می‌شود.
          </LegalCard>
          <LegalCard title="ارزش‌های ما">
            صداقت در مشاوره، اصالت کالا، احترام به بودجهٔ مشتری، و پشتیبانی پس از فروش که واقعاً
            پاسخ‌گو باشد.
          </LegalCard>
        </div>
      </LegalSection>
      ...
      <LegalSection title="چه چیزی آفلند را متمایز می‌کند؟">
        <LegalList
          items={[
            <span key="1">
              <strong className="text-[var(--offl-text)]">تخصص در قطعات:</strong> تمرکز روی
              سخت‌افزار کامپیوتر و لوازم دیجیتال، نه هر چیزی — پس مشاوره واقعی است.
            </span>,
            <span key="2">
              <strong className="text-[var(--offl-text)]">دستیار هوشمند:</strong> چتی که مثل یک
              کارشناس فروش حرفه‌ای، محصول مناسب را پیشنهاد می‌دهد.
            </span>,
            <span key="3">
              <strong className="text-[var(--offl-text)]">جادوگر اسمبل:</strong> چیدن سیستم سازگار و
              بهینه فقط با انتخاب کاربری و بودجه.
            </span>,
            <span key="4">
              <strong className="text-[var(--offl-text)]">قیمت رقابتی:</strong> مدل «سرزمینِ تخفیف»
              یعنی قیمت‌گذاری شفاف و تخفیف‌های واقعی.
            </span>,
            <span key="5">
              <strong className="text-[var(--offl-text)]">گارانتی اصل:</strong> فقط کالای با گارانتی
              معتبر شرکت‌های مجاز — بخوانید{' '}
              <Link
                href="/warranty"
            ...
            <span key="6">
              <strong className="text-[var(--offl-text)]">ارسال سریع:</strong> پست پیشتاز، تیپاکس و
              پیک موتوری به سراسر ایران.
            </span>,
          ]}
        />
      </LegalSection>
      ...
      <LegalSection title="فناوری‌های ما">
        <p>
          آفلند روی نسل جدید وب ساخته شده است: رابط کاربری سریع و مدرن با Next.js، تجربهٔ یکپارچه در
          موبایل و دسکتاپ، و لایهٔ هوش مصنوعی که بدون پیچیدگی فنی در خدمت توست. ما از چندین
          ارائه‌دهندهٔ مدل زبانی (LLM) استفاده می‌کنیم تا دستیار هوشمند همیشه در دسترس و به‌صرفه
          بماند — بدون اینکه تو نیازی به دانستن جزئیات فنی داشته باشی.
        </p>
      </LegalSection>

      <LegalSection title="دستیار هوشمند آفلند">
        <p>
          <span className="font-medium text-[var(--offl-primary)]">دستیار هوشمند آفلند</span> یک
          مشاور خرید و مقایسهٔ هوشمند است که به زبان فارسی، روان و دوستانه با تو صحبت می‌کند.
          کاربردهای اصلی آن:
        </p>
        <LegalList
          items={[
        ...
        <p className="!mt-3 text-[14px] text-[var(--offl-text-muted)]">
          نکته: پیشنهادهای دستیار صرفاً کمک‌تصمیم‌گیری هستند و مسئولیت نهایی انتخاب با خودتان است.
        </p>
      </LegalSection>
      ...
      <LegalSection title="جادوگر اسمبل هوشمند" id="assemble">
        ...
        <p className="!mt-3 text-[14px]">
          سیستم سازگاری قطعات را بررسی می‌کند، اما همیشه پیش از ثبت نهایی، یک بار چیدمان را چک کن.
        </p>
      </LegalSection>
      ...
      <LegalSection title="تیم ما">
        <p>
          آفلند پشتِ یک تیم کوچک اما عاشق سخت‌افزار، توسعه‌دهنده و پشتیبانی است که باور دارند خرید
          فنی باید ساده و صادقانه باشد. ما ترجیح می‌دهیم به‌جای شعار، با هر سفارش ثابت کنیم که
          «سرزمینِ تخفیف» واقعاً به نفع توست.
        </p>
      </LegalSection>
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
          {[
            ...
            >
              ...
              <p className="mt-1 font-light text-[13px] text-[var(--offl-text-muted)]">{s.label}</p>
            </div>
          ))}
        </div>
