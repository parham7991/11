  ...
  return (
    ...
    >
      <LegalSection title="چطور می‌توانیم کمک کنیم؟">
        <p>
          برای پشتیبانی، مشاورهٔ فنی، پیگیری سفارش یا دریافت خدمات گارانتی، از یکی از
          راه‌های زیر استفاده کن. تیم آفلند آمادهٔ پاسخ‌گویی است.
        </p>
      </LegalSection>
          ...
          <LegalList
            items={[
              ...
              <span key="2">
                ...
                هم بپرسید — سریع‌تر و شبانه‌روزی.
              </span>,
              <span key="3">
