  ...
  return (
    <g className={cls}>
      <rect
        ...
        style={state === 'present' ? { stroke: accentB, fill: `${accentB}14` } : undefined}
      />
      {state === 'present' && (
        <rect
          x={x}
          ...
          height={h}
          rx={9}
          className="aw-case__slot-glow"
          filter={`url(#${glowId})`}
          style={{ stroke: accentB }}
        />
      )}
      <foreignObject x={x} y={y} width={w} height={h} className="aw-case__fo">
        <div className="aw-case__slot-inner">
          ...
          {state === 'blocked' && (
            <span className="aw-case__slot-flag aw-case__slot-flag--bad">ناسازگار</span>
          )}
        </div>
      </foreignObject>
      {/* نقطه وضعیت */}
      <circle
        ...
        cy={y + 12}
        r={4.5}
        className={`aw-case__dot aw-case__dot--${state}`}
      />
      <title>{label}</title>
    </g>
  );
 ...
 */
export default function PcBuildVisual({
  parts,
  theme = 'stealth',
  blockedIds,
  unavailableIds,
  ...
  return (
    <div
      className={`aw-case aw-case--${theme}`}
      style={{ ['--aw-accent-a' as any]: accent.a, ['--aw-accent-b' as any]: accent.b }}
    >
        ...
        {byCat['case'] && (
          <g className="aw-case__case-ind">
            <rect
              ...
              height="250"
              rx="6"
              className="aw-case__case-bar"
              style={{ fill: `${accent.b}1f`, stroke: accent.b }}
            />
          </g>
        )}
      ...
      <div className="aw-case__legend">
        <span>
          <i className="aw-case__leg-dot aw-case__leg-dot--present" />
          نصب شده
        </span>
        <span>
          <i className="aw-case__leg-dot aw-case__leg-dot--blocked" />
          ناسازگار
        </span>
        <span>
          <i className="aw-case__leg-dot aw-case__leg-dot--unavailable" />
          ناموجود
        </span>
        <span>
          <i className="aw-case__leg-dot aw-case__leg-dot--empty" />
          فضای خالی
        </span>
      </div>
    </div>
