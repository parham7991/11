...
function validate(v: FormState): Errors {
  ...
  if (!MOBILE_RE.test(v.mobile.trim()))
    e.mobile = 'شماره موبایل باید ۱۱ رقم و با ۰۹ شروع شود.';
  ...
  if (v.message.trim().length < 10)
    e.message = 'متن پیام باید حداقل ۱۰ حرف باشد.';
  return e;
}
    ...
    <div className="rounded-2xl border border-[var(--offl-border)] bg-[var(--offl-surface)] p-6 lg:p-8">
      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          <div>
            <label htmlFor="cf-name" className="mb-1.5 block font-medium text-[14px] text-[var(--offl-text)]">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label htmlFor="cf-mobile" className="mb-1.5 block font-medium text-[14px] text-[var(--offl-text)]">
            ...
            <div>
              <label htmlFor="cf-email" className="mb-1.5 block font-medium text-[14px] text-[var(--offl-text)]">
          ...
          <div>
            <label htmlFor="cf-subject" className="mb-1.5 block font-medium text-[14px] text-[var(--offl-text)]">
          ...
          <div>
            <label htmlFor="cf-message" className="mb-1.5 block font-medium text-[14px] text-[var(--offl-text)]">
