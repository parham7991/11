    ...
    >
      <span className="asm-header-btn__icon">
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="10" y="10" width="4" height="4" rx="0.5" stroke="currentColor" strokeWidth="1.8" />
          <path d="M9 4v3M12 4v3M15 4v3M9 17v3M12 17v3M15 17v3M4 9h3M4 12h3M4 15h3M17 9h3M17 12h3M17 15h3" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
        </svg>
