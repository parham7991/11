...
export default function PWAClient() {
  ...
  const canInstall = useMemo(
    () => Boolean(installPrompt) && !installed && !dismissed,
  ...
  const install = async () => {
    ...
    if (choice?.outcome === 'accepted') {
      ...
      localStorage.setItem(
        'offland-pwa-install-hide-until',
    ...
    <>
      {!online && (
        <div className="pwa-net pwa-net--offline" role="status">
          <span className="pwa-net__icon" aria-hidden="true">
            <WifiOffIcon />
          </span>
      ...
      {showInstall && canInstall && (
        <div className="pwa-install" role="dialog" aria-label="نصب اپ آفلند">
          ...
          <div className="pwa-install__actions">
            <button type="button" className="pwa-install__primary" onClick={install}>
              نصب اپ
            </button>
            <button type="button" className="pwa-install__ghost" onClick={dismissInstall}>
              بعداً
            </button>
          </div>
        </div>
      ...
      {updateReady && (
        <div className="pwa-update" role="status">
          <span className="pwa-update__icon">
            <RefreshIcon />
          </span>
      ...
      <style jsx global>{`
        .pwa-net {
          ...
          animation: pwaSlide 0.35s ease both;
        }
        .pwa-net__icon {
          width: 22px;
          height: 22px;
        ...
        .pwa-net--online {
          ...
          animation:
            pwaSlide 0.35s ease both,
            pwaFadeOut 0.35s ease 3s forwards;
        }
        .pwa-install {
          position: fixed;
          right: 18px;
          ...
          box-shadow: 0 24px 70px rgba(20, 35, 80, 0.22);
          animation: pwaSlide 0.42s cubic-bezier(0.2, 0.8, 0.2, 1) both;
        }
        .pwa-install__icon {
          width: 54px;
          height: 54px;
          ...
          place-items: center;
          color: white;
          box-shadow: 0 15px 32px rgba(56, 107, 249, 0.28);
        }
        ...
        .pwa-install__body strong {
          font-size: 14px;
          color: #182235;
        }
        .pwa-install__body span {
          font-size: 12px;
          line-height: 1.8;
          color: #667085;
        }
        ...
        .pwa-install__primary {
          background: #386bf9;
          color: white;
          box-shadow: 0 10px 24px rgba(56, 107, 249, 0.25);
        }
        .pwa-install__ghost {
          background: #eef2fb;
          color: #334155;
...
function ChipIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none">
      ...
      <rect x="10" y="10" width="4" height="4" rx=".5" stroke="currentColor" strokeWidth="1.8" />
      <path
...
function WifiOffIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none">
      <path
        d="M3 3l18 18M8.5 16.5a5 5 0 0 1 7 0M5.5 13.5a9 9 0 0 1 4.2-2.2M14.5 11.4a9 9 0 0 1 4 2.1M2.5 10.5a13 13 0 0 1 4.1-2.8M10.5 6.7A13 13 0 0 1 21.5 10.5M12 20h.01"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
