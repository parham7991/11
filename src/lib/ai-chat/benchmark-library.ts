...
export const COMPLETE_BENCHMARK_LIBRARY: BenchmarkItem[] = [
  // ═════ AAA Games ═════
  {
    ...
    category: 'GAME_AAA',
    baseGpuScoreThreshold: 85,
    baseCpuScoreThreshold: 80,
    gpuWeight: 0.65,
    cpuWeight: 0.35,
    fpsMultiplier: 0.85,
    unit: 'FPS @ 1440p',
  ...
  },
  {
    ...
    category: 'GAME_AAA',
    baseGpuScoreThreshold: 90,
    baseCpuScoreThreshold: 75,
    gpuWeight: 0.8,
    cpuWeight: 0.2,
    fpsMultiplier: 0.9,
    unit: 'FPS @ 1440p',
  ...
  },
  {
    ...
    category: 'GAME_AAA',
    baseGpuScoreThreshold: 88,
    baseCpuScoreThreshold: 70,
    gpuWeight: 0.8,
    cpuWeight: 0.2,
    fpsMultiplier: 0.75,
    unit: 'FPS @ 1440p',
  ...
  },
  {
    ...
    category: 'GAME_AAA',
    baseGpuScoreThreshold: 70,
    baseCpuScoreThreshold: 65,
    gpuWeight: 0.6,
    cpuWeight: 0.4,
    fpsMultiplier: 1.5,
    unit: 'FPS @ 1440p',
  ...
  },
  {
    ...
    category: 'GAME_AAA',
    baseGpuScoreThreshold: 82,
    baseCpuScoreThreshold: 72,
    gpuWeight: 0.72,
    cpuWeight: 0.28,
    fpsMultiplier: 1.0,
    unit: 'FPS @ 1440p',
  ...
  // ═════ Esports ═════
  {
    ...
    baseGpuScoreThreshold: 50,
    baseCpuScoreThreshold: 85,
    gpuWeight: 0.3,
    cpuWeight: 0.7,
    fpsMultiplier: 3.8,
    unit: 'FPS @ 1080p',
  ...
  },
  {
    ...
    category: 'GAME_ESPORTS',
    baseGpuScoreThreshold: 60,
    baseCpuScoreThreshold: 88,
    gpuWeight: 0.35,
    cpuWeight: 0.65,
    fpsMultiplier: 3.5,
    unit: 'FPS @ 1080p',
  ...
  // ═════ Video Rendering ═════
  {
    ...
    baseGpuScoreThreshold: 80,
    baseCpuScoreThreshold: 85,
    gpuWeight: 0.45,
    cpuWeight: 0.55,
    fpsMultiplier: 0,
    unit: 'امتیاز سرعت (۰-۱۰)',
  ...
  },
  {
    ...
    category: 'RENDER_VIDEO',
    baseGpuScoreThreshold: 70,
    baseCpuScoreThreshold: 90,
    gpuWeight: 0.35,
    cpuWeight: 0.65,
    fpsMultiplier: 0,
    unit: 'روانی پیش‌نمایش (۰-۱۰)',
  ...
  // ═════ AI / Coding ═════
  {
    ...
    category: 'AI_CODING',
    baseGpuScoreThreshold: 95,
    baseCpuScoreThreshold: 75,
    gpuWeight: 0.9,
    cpuWeight: 0.1,
    fpsMultiplier: 0,
    unit: 'امتیاز سرعت آموزش (۰-۱۰)',
  ...
  },
  {
    ...
    category: 'AI_CODING',
    baseGpuScoreThreshold: 90,
    baseCpuScoreThreshold: 60,
    gpuWeight: 0.9,
    cpuWeight: 0.1,
    fpsMultiplier: 0,
    unit: 'امتیاز سرعت تولید (۰-۱۰)',
  ...
  },
  {
    ...
    category: 'AI_CODING',
    baseGpuScoreThreshold: 30,
    baseCpuScoreThreshold: 92,
    gpuWeight: 0.1,
    cpuWeight: 0.9,
    fpsMultiplier: 0,
    unit: 'امتیاز چندوظیفگی (۰-۱۰)',
